...
class CoinGlassAPI:
    ...
    async def get_liquidation_exchange_list(self, symbol: str) -> Dict[str, Any]:
        """
        Get liquidation data for specific coin across all exchanges
        Update interval: 10 seconds
        """
        return await self._make_request(
            "/api/futures/liquidation/exchange-list", {"symbol": symbol}
        )
    ...
    async def get_supported_coins(self) -> Dict[str, Any]:
        ...
        """
        return await self._make_request("/futures/supported-coins")
    ...
    async def get_supported_exchange_pairs(self) -> Dict[str, Any]:
        ...
        Update interval: 1 minute
        """
        return await self._make_request("/futures/supported-exchange-pairs")
    ...
    async def get_price_change_list(self) -> Dict[str, Any]:
        ...
        Update interval: Real-time
        """
        return await self._make_request("/futures/price-change-list")
